...
"""autogenerated by genpy from checkloop/GetModeRequest.msg. Do not edit."""
import sys
...
class GetModeRequest(genpy.Message):
  ...
  _type = "checkloop/GetModeRequest"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_3B.pack(_x.localize, _x.map, _x.applyChange))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.localize, _x.map, _x.applyChange,) = _struct_3B.unpack(str[start:end])
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from checkloop/GetModeResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class GetModeResponse(genpy.Message):
  ...
  _type = "checkloop/GetModeResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """bool localize
bool map
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_struct_2B.pack(_x.localize, _x.map))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.localize, _x.map,) = _struct_2B.unpack(str[start:end])
      self.localize = bool(self.localize)
      self.map = bool(self.map)
      return self
    except struct.error as e:
