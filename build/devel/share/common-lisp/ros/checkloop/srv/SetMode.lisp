...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<SetMode-request> is deprecated: use checkloop-srv:SetMode-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<SetMode-response> is deprecated: use checkloop-srv:SetMode-response instead.")))
