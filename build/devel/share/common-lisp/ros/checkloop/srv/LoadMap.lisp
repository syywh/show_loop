...
(cl:defmethod cl:initialize-instance :after ((m <LoadMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<LoadMap-request> is deprecated: use checkloop-srv:LoadMap-request instead.")))

(cl:ensure-generic-function 'filename-val :lambda-list '(m))
(cl:defmethod filename-val ((m <LoadMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:filename-val is deprecated.  Use checkloop-srv:filename instead.")
  (filename m))
...
(cl:defmethod cl:initialize-instance :after ((m <LoadMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'LoadMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<LoadMap-response> is deprecated: use checkloop-srv:LoadMap-response instead.")))
