...
(cl:defmethod cl:initialize-instance :after ((m <GetBoundedMap-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBoundedMap-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<GetBoundedMap-request> is deprecated: use checkloop-srv:GetBoundedMap-request instead.")))

(cl:ensure-generic-function 'mapCenter-val :lambda-list '(m))
(cl:defmethod mapCenter-val ((m <GetBoundedMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:mapCenter-val is deprecated.  Use checkloop-srv:mapCenter instead.")
  (mapCenter m))

(cl:ensure-generic-function 'topRightCorner-val :lambda-list '(m))
(cl:defmethod topRightCorner-val ((m <GetBoundedMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:topRightCorner-val is deprecated.  Use checkloop-srv:topRightCorner instead.")
  (topRightCorner m))

(cl:ensure-generic-function 'bottomLeftCorner-val :lambda-list '(m))
(cl:defmethod bottomLeftCorner-val ((m <GetBoundedMap-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:bottomLeftCorner-val is deprecated.  Use checkloop-srv:bottomLeftCorner instead.")
  (bottomLeftCorner m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetBoundedMap-request>)))
  ...
  "checkloop/GetBoundedMapRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetBoundedMap-request)))
  "Returns string type for a service object of type 'GetBoundedMap-request"
  "checkloop/GetBoundedMapRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <GetBoundedMap-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetBoundedMap-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<GetBoundedMap-response> is deprecated: use checkloop-srv:GetBoundedMap-response instead.")))

(cl:ensure-generic-function 'boundedMap-val :lambda-list '(m))
(cl:defmethod boundedMap-val ((m <GetBoundedMap-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:boundedMap-val is deprecated.  Use checkloop-srv:boundedMap instead.")
  (boundedMap m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetBoundedMap-response>)))
  ...
  "checkloop/GetBoundedMapResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetBoundedMap-response)))
  "Returns string type for a service object of type 'GetBoundedMap-response"
  "checkloop/GetBoundedMapResponse")
