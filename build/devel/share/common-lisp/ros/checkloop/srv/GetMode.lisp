...
(cl:defmethod cl:initialize-instance :after ((m <GetMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<GetMode-request> is deprecated: use checkloop-srv:GetMode-request instead.")))

(cl:ensure-generic-function 'localize-val :lambda-list '(m))
(cl:defmethod localize-val ((m <GetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:localize-val is deprecated.  Use checkloop-srv:localize instead.")
  (localize m))

(cl:ensure-generic-function 'map-val :lambda-list '(m))
(cl:defmethod map-val ((m <GetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:map-val is deprecated.  Use checkloop-srv:map instead.")
  (map m))

(cl:ensure-generic-function 'applyChange-val :lambda-list '(m))
(cl:defmethod applyChange-val ((m <GetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:applyChange-val is deprecated.  Use checkloop-srv:applyChange instead.")
  (applyChange m))
...
(cl:defmethod cl:initialize-instance :after ((m <GetMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<GetMode-response> is deprecated: use checkloop-srv:GetMode-response instead.")))
