...
(cl:defmethod cl:initialize-instance :after ((m <CorrectPose-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CorrectPose-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<CorrectPose-request> is deprecated: use checkloop-srv:CorrectPose-request instead.")))

(cl:ensure-generic-function 'odom-val :lambda-list '(m))
(cl:defmethod odom-val ((m <CorrectPose-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:odom-val is deprecated.  Use checkloop-srv:odom instead.")
  (odom m))
...
(cl:defmethod cl:initialize-instance :after ((m <CorrectPose-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CorrectPose-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<CorrectPose-response> is deprecated: use checkloop-srv:CorrectPose-response instead.")))
