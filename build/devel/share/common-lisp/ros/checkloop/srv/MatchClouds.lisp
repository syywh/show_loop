...
(cl:defmethod cl:initialize-instance :after ((m <MatchClouds-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MatchClouds-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<MatchClouds-request> is deprecated: use checkloop-srv:MatchClouds-request instead.")))

(cl:ensure-generic-function 'reference-val :lambda-list '(m))
(cl:defmethod reference-val ((m <MatchClouds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:reference-val is deprecated.  Use checkloop-srv:reference instead.")
  (reference m))

(cl:ensure-generic-function 'readings-val :lambda-list '(m))
(cl:defmethod readings-val ((m <MatchClouds-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:readings-val is deprecated.  Use checkloop-srv:readings instead.")
  (readings m))
...
(cl:defmethod cl:initialize-instance :after ((m <MatchClouds-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MatchClouds-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name checkloop-srv:<MatchClouds-response> is deprecated: use checkloop-srv:MatchClouds-response instead.")))

(cl:ensure-generic-function 'transform-val :lambda-list '(m))
(cl:defmethod transform-val ((m <MatchClouds-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader checkloop-srv:transform-val is deprecated.  Use checkloop-srv:transform instead.")
  (transform m))
